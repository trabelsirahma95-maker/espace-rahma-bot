...
- If customer asks what products are available, present the main options.
- If customer has a budget, suggest the closest product.
- If customer wants to order, ask for: name, phone number, address, desired date.
